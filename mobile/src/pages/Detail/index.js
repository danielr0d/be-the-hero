...
export default function Detail() {
    ...
    const message = `Olá ${incident.name}, estou entrando em contato pois gostaria de ajudar no caso ${incident.title} com o valor de  ${{style: 'currency', 
    ...
    function sendWhatsapp() {
        Linking.openURL(`whatsapp://send?phone=${indent.whatsapp}&text=${message}`);
    }
